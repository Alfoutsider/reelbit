    ...
    <footer className="mt-auto pt-10 pb-6 px-4" style={{ background: "var(--footer-bg)", borderTop: "1px solid var(--footer-bdr)" }}>
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-2 md:col-span-1 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <img src="/logo-icon.svg" alt="ReelBit" className="w-8 h-8 object-contain" />
              <span className="font-orbitron text-[14px] font-black leading-none">
                ...
                <span style={{ color: "var(--footer-t)" }}>.fun</span>
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {LINKS.social.map(({ href, label }) => (
                <a key={href} href={href} target="_blank" rel="noopener noreferrer"
                  ...
                  style={{ background: "rgba(196,30,30,0.04)", border: "1px solid rgba(196,30,30,0.12)", color: "var(--footer-l)" }}>
                  {label}
                </a>
              ))}
            </div>
          ...
          {/* Platform */}
          <div>
            <p className="font-orbitron text-[9px] font-bold tracking-widest mb-3 uppercase" style={{ color: "var(--footer-t)" }}>Platform</p>
          ...
          {/* Legal */}
          <div>
            <p className="font-orbitron text-[9px] font-bold tracking-widest mb-3 uppercase" style={{ color: "var(--footer-t)" }}>Legal</p>
            <ul className="space-y-2">
          ...
          {/* Risk warning */}
          <div>
            <p className="font-orbitron text-[9px] font-bold tracking-widest mb-3 uppercase" style={{ color: "var(--footer-t)" }}>Risk Warning</p>
            <p className="text-[11px] font-rajdhani leading-relaxed" style={{ color: "var(--footer-t)" }}>
        ...
        <div className="pt-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-[10px] font-orbitron tracking-wide"
          style={{ borderTop: "1px solid var(--footer-bdr)", color: "var(--footer-t)" }}>
